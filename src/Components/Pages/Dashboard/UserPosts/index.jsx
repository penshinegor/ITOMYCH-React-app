...
const UserPosts = () => {
    ...
    if(error) {
        return(
            <>
                <h1 className="text-center mt-5 mb-5">Post with this id doesn't exist</h1>
                <button onClick={goBack} className="d-block mx-auto w-25 btn btn-lg btn-primary mt-5">Back to dashboard</button>
